...
- (void)setupScanView {
    ...
    _slideLineView = [[UIView alloc]initWithFrame:CGRectMake(_viewWidth, 201, SCREEN_WIDTH - _viewWidth * 2, 1)];
...
- (void)setupSubView {
    _titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 500, SCREEN_WIDTH, 50.0)];
    _titleLabel.text = @"请将二维码放入框内";
    _titleLabel.textAlignment = NSTextAlignmentCenter;
    _titleLabel.textColor = [UIColor whiteColor];
    [_scan addSubview:_titleLabel];
    
    _lightButton = [[UIButton alloc]initWithFrame:CGRectMake(SCREEN_WIDTH/2 - 100, _titleLabel.frame.origin.y + _titleLabel.frame.size.height + 50, 50, 50)];
    [_lightButton setTitle:@"灯" forState:UIControlStateNormal];
    ...
    _imageButton = [[UIButton alloc]initWithFrame:CGRectMake(SCREEN_WIDTH/2 + 50, _titleLabel.frame.origin.y + _titleLabel.frame.size.height + 50, 50, 50)];
