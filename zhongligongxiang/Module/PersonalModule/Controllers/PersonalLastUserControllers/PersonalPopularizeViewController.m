//
//  PersonalPopularizeViewController.m
//  zhongligongxiang
//
...
@interface PersonalPopularizeViewController ()

@property (nonatomic,strong) UIImageView * backImageView;
@property (nonatomic,strong) UIButton * aplyBtn;
@end

@implementation PersonalPopularizeViewController

-(UIImageView *)backImageView{
    
    if (!_backImageView) {
        _backImageView = [[UIImageView alloc] initWithFrame:SCREEN_RECT];
        _backImageView.image = [UIImage imageNamed:@"Personal_popularize"];
    }
